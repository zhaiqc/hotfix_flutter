...
public class MainActivity extends HotFixFlutterActivity implements EasyPermissions.PermissionCallbacks,
  ...
  public void install_patch( ) {
    ...
    TinkerInstaller.onReceiveUpgradePatch(getApplicationContext(), Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).getPath() + "/patch_signed_7zip.apk");
    Log.i("hcc", "install_patch: " +Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).getPath()+"/patch_signed_7zip.apk" );
